				...
				$result_Depositos = $var->freeRun("SELECT
                                                    ...
                                                    FROM 
                                                    	...
                                                    	inner join usuario usu on 
                                                    	    usu.idusuario = sp.usuario_idusuario
                                                    
                                                    ");

				$row_cnt = mysqli_num_rows($result_Depositos);
				?>
    <div class="card ">
         <div class="card-header" style="    padding-bottom: 0px;">
            <i class="fa fa-table"></i> SUPORTE 
         </div>
         <div class="card-body">
			...
			if($linha['resolvido'] == 1|| $linha['atendido'] == 1){
			...
			?>	
				<tr <?php echo $color;?>>
			    <form method="post" action="Suporte_POST.php">
				    <td><?php echo $linha['atendido'];  ?></td>
				    <td><button type='submit' class='btn btn-primary' id='idtxticket' name='idtxticket' value='<?php echo $linha['idmensagem'];  ?>'></td>
					<td><?php echo $linha['idmensagem'];  ?></td>	
					...
					<td><?php echo $linha['dataabertura'];  ?></td>
